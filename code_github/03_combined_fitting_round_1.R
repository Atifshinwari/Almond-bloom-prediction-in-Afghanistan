...
# hour_temps <- read.csv('data/Ravensburg_hourly_temp.csv')
# bloom_dates <- read.csv('data/Ravensburg_bloom_dates.csv')
...
fname <- 'data/parameter_combined_fitting_round_1.csv'
...
ggsave(plot = combine_perfo_plot, filename = "plot/combine_fit_stat/combine_plot_R1.png", width = 16, height = 10, dpi = 600)
...
long_df <- long_df %>%
  filter(!(metric == "rpiq_adj" & value > 50))
...
ggsave(plot = RMSE_box_A, filename = "plot/box plot/RMSE_box_R1_Outlier.png", width = 16, height = 10, dpi = 600)
ggsave(plot = RMSE_box_A, filename = "plot/box plot/RMSE_box_R1.png", width = 16, height = 10, dpi = 600)

# outliers at 50, 150 of RPIQ for two varieties = Qaharbai and Marawaja Kaghazi
